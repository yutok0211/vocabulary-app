    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <button
          ...
          className="flex flex-col items-start gap-3 rounded-2xl border bg-white p-6 text-left shadow-sm hover:border-amber-300 hover:shadow-md"
        >
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-amber-100 text-amber-600">
            <SlidersHorizontal size={22} />
          </div>
          <div>
            <p className="font-semibold text-gray-800">ニュアンス比較モード</p>
            <p className="mt-1 text-sm text-gray-500">シチュエーション文から、同じ系統の単語グループの中で正しい強度の語を選ぶモード</p>
          </div>
        </button>
      </div>
    </div>
